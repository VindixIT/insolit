function editContratoReparticao(e) {
	...
	document.getElementById('ContratoReparticaoIdForUpdate').value = contratoId;
...
function deleteContratoReparticao(e) {
    var deleteForm = document.getElementById('delete-form');
    deleteForm.style.display = 'block';
    var contratoId = e.parentNode.parentNode.childNodes[3].innerText;
    document.getElementById('ContratoReparticaoIdForDelete').value = contratoId;
}