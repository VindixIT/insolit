function editFaturaReparticao(e) {
    ...
    var contratoInvestidor = e.parentNode.parentNode.childNodes[7].innerText;
	...
	document.getElementById('FaturaReparticaoIdForUpdate').value = faturaId;
    document.getElementById('ContratoForUpdate').value = contratoId;
    document.getElementById('ContratoInvestidorForUpdate').value = contratoInvestidor;
...
function deleteFaturaReparticao(e) {
    ...
    var faturaId = e.parentNode.parentNode.childNodes[3].innerText;
    document.getElementById('FaturaReparticaoIdForDelete').value = faturaId;
}